  ...
  return (
    <Row className="d-flex justify-content-center">
      <Col xl={8} lg={12}>
        ...
        <p>Updated at 2025-12-24</p>
        <h1>General Terms</h1>
        <p>
          By accessing and placing an order with Guessthecry, you confirm that
        ...
        <p>
          Under no circumstances shall Guessthecry team be liable for any
          ...
          Guessthecry team or an authorized representative has been advised of
        ...
        <h1>License</h1>
        <p>
          Guessthecry grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website strictly in
          accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and Guessthecry
          (referred to in these Terms & Conditions as "Guessthecry", "us", "we"
          or "our"), the provider of the Guessthecry website and the services
          accessible from the Guessthecry website (which are collectively
          referred to in these Terms & Conditions as the "Guessthecry Service").
        </p>
        <p>
          ...
          Guessthecry Service. In these Terms & Conditions, "you" refers both to
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Guessthecry, that is responsible for your information
            under this Terms & Conditions.
          </li>
          <li>
            Country: where Guessthecry or the owners/founders of Guessthecry are
            based, in this case is{" "}
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Guessthecry
            and use the services.
          </li>
          <li>
            Service: refers to the service provided by Guessthecry as described
          ...
          <li>
            Website: Guessthecry's site, which can be accessed via this URL:
            https://guessthecry.com/
          </li>
          <li>
            You: a person or entity that is registered with Guessthecry to use
            the Services.
          </li>
        </ul>
        <h1>Restrictions</h1>
        ...
        <ul>
          ...
          <li>
            ...
            notice of copyright or trademark) of Guessthecry or its affiliates,
            partners, suppliers or the licensors of the website.
          </li>
        </ul>
        <h1>Return and Refund Policy</h1>
        <p>
          Thanks for shopping at Guessthecry. We appreciate the fact that you
        ...
        <p>
          ...
          apply to transactions at Guessthecry. We’ll be as brief as our
          attorneys will allow. The main thing to remember is that by placing an
          order or making a purchase at Guessthecry, you agree to the terms
          along with Guessthecry's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          (collectively, "Suggestions") provided by you to Guessthecry with
          respect to the website shall remain the sole and exclusive property of
          Guessthecry.
        </p>
        <p>
          Guessthecry shall be free to use, copy, modify, publish, or
        ...
        <p>
          ...
          Guessthecry. We are not responsible for the content, accuracy or
        ...
        <h1>Cookies</h1>
        <p>
          Guessthecry uses "Cookies" to identify the areas of our website that
        ...
        <p>
          You acknowledge and agree that Guessthecry may stop (permanently or
          ...
          do not need to specifically inform Guessthecry when you stop using the
          Service. You acknowledge and agree that if Guessthecry disables access
        ...
        <p>
          Guessthecry reserves the right to modify, suspend or discontinue,
        ...
        <p>
          Guessthecry may from time to time provide enhancements or improvements
        ...
        <p>
          ...
          of the website. You agree that Guessthecry has no obligation to (i)
        ...
        <p>
          You acknowledge and agree that Guessthecry shall not be responsible
          ...
          or any other aspect thereof. Guessthecry does not assume and shall not
        ...
        <p>
          Guessthecry may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Guessthecry, in the event that you fail to comply with any provision
        ...
        <p>
          Termination of this Agreement will not limit any of Guessthecry's
        ...
        <p>
          You agree to indemnify and hold Guessthecry and its parents,
        ...
        <p>
          ...
          permitted under applicable law, Guessthecry, on its own behalf and on
          ...
          trade practice. Without limitation to the foregoing, Guessthecry
        ...
        <p>
          Without limiting the foregoing, neither Guessthecry nor any
          Guessthecry's provider makes any representation or warranty of any
          ...
          of Guessthecry are free of viruses, scripts, trojan horses, worms,
        ...
        <p>
          ...
          of Guessthecry and any of its suppliers under any provision of this
        ...
        <p>
          ...
          Guessthecry or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if Guessthecry or any supplier has
        ...
        <p>
          ...
          notices published by Guessthecry on the Services, shall constitute the
          entire agreement between you and Guessthecry concerning the Services.
          ...
          term or any other term, and Guessthecry's failure to assert any right
          or provision under this Agreement shall not constitute a waiver of
          such right or provision. YOU AND Guessthecry AGREE THAT ANY CAUSE OF
        ...
        <p>
          Guessthecry reserves the right, at its sole discretion, to modify or
        ...
        <p>
          ...
          Guessthecry regarding your use of the website and supersedes all prior
        ...
        <p>
          ...
          you use or purchase other Guessthecry's services, which Guessthecry
        ...
        <p>
          ...
          arrangement thereof), are owned by Guessthecry, its licensors or other
          ...
          Guessthecry, unless and except as is expressly provided in these Terms
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Guessthecry's
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and Guessthecry concerning
        ...
        <p>
          In the event of a dispute, you or Guessthecry must give the other a
          ...
          is sent. After sixty (60) days, you or Guessthecry may commence
          arbitration.
        </p>
        <h1>Binding Arbitration</h1>
        <p>
          If you and Guessthecry don’t resolve any dispute by informal
        ...
        <p>
          ...
          and will become the sole property of Guessthecry without any
          compensation or credit to you whatsoever. Guessthecry and its
        ...
        <h1>Promotions</h1>
        <p>
          Guessthecry may, from time to time, include contests, promotions,
        ...
        <p>
          ...
          representative of Guessthecry. Guessthecry will be entitled to
          ...
          breach by you. Guessthecry operates and controls the Guessthecry
          ...
          Guessthecry Service from other locations do so on their own initiative
          ...
          include and incorporate the Guessthecry Privacy Policy) contains the
          entire understanding, and supersedes all prior understandings, between
          you and Guessthecry concerning its subject matter, and cannot be
        ...
        <h1>Disclaimer</h1>
        <p>
          Guessthecry is not responsible for any content, code or any other
          imprecision.
        </p>
        <p>Guessthecry does not provide warranties or guarantees.</p>
        <p>
          In no event shall Guessthecry be liable for any special, direct,
        ...
        <p>
          The Guessthecry Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. Guessthecry is a distributor and not a
          publisher of the content supplied by third parties; as such,
          Guessthecry exercises no editorial control over such content and makes
          ...
          through or accessible via the Guessthecry Service. Without limiting
          the foregoing, Guessthecry specifically disclaims all warranties and
          representations in any content transmitted on or in connection with
          the Guessthecry Service or on sites that may appear as links on the
          Guessthecry Service, or in the products provided as a part of, or
          otherwise in connection with, the Guessthecry Service, including
          without limitation any warranties of merchantability, fitness for a
          particular purpose or non-infringement of third party rights. No oral
          advice or written information given by Guessthecry or any of its
          ...
          change without notice. Without limiting the foregoing, Guessthecry
          does not warrant that the Guessthecry Service will be uninterrupted,
