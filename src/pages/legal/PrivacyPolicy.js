  ...
  return (
    <Row className="d-flex justify-content-center">
      <Col xl={8} lg={12}>
        ...
        <p>
          {" "}
          Guessthecry (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Guessthecry.
        </p>
        <p>
          ...
          Guessthecry. By accessing or using our Service, you signify that you
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Guessthecry, that is responsible for your
              information under this Privacy Policy.
            </li>
            <li>
              Country: where Guessthecry or the owners/founders of Guessthecry
              are based, in this case is United States
            </li>
            <li>
              Customer: refers to the company, organization or person that signs
              up to use the Guessthecry Service to manage the relationships with
            ...
            <li>
              ...
              Guessthecry or are under contract to perform a service on behalf
            ...
            <li>
              Service: refers to the service provided by Guessthecry as
        ...
        <h1>
          When does Guessthecry use end user information from third parties?
        </h1>
        <p>
          Guessthecry will collect End User Data necessary to provide the
          Guessthecry services to our customers.
        </p>
        <p>
        ...
        <h1>
          When does Guessthecry use customer information from third parties?
        </h1>
        <p>
          ...
          interest in becoming a Guessthecry customer, we receive information
          from a third party that provides automated fraud detection services to
          Guessthecry. We also occasionally collect information that is made
        ...
        <p>
          Guessthecry will collect personal information that you submit to us.
        ...
        <p>
          ...
          Guessthecry to you and fulfill the purposes described in this policy.
        ...
        <p>
          ...
          absolute security of any information you transmit to Guessthecry or
        ...
        <p>
          Guessthecry is incorporated in United States. Information collected
        ...
        <h1>
          Is the information collected through the Guessthecry Service secure?
        </h1>
        <p>
        ...
        <p>
          ...
          information Guessthecry collects depend on your relationship with
          Guessthecry. Personnel may update or correct their information as
        ...
        <p>
          ...
          of the assets of Guessthecry or any of its Corporate Affiliates (as
          defined herein), or that portion of Guessthecry or any of its
        ...
        <p>
          ...
          Guessthecry, whether by ownership or otherwise. Any information
        ...
        <p>
          By using Guessthecry or contacting us directly, you signify your
        ...
        <p>
          ...
          right thing to do. At Guessthecry we strongly believe that your data
        ...
        <p>
          ...
          requirements of GDPR. Guessthecry processes or stores all personal
